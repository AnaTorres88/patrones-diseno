...
abstract class Notification {
  ...
  abstract setChannel(message: NotificationChannel): void;
...
// Notas para mi: revisar lo que estamos pasando como argumentos a la función para poder usar el tipo correcto